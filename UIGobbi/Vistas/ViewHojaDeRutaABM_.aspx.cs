...
public partial class Vistas_ViewHojaDeRutaABM_ : GobbiPage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            Ajax.Utility.RegisterTypeForAjax(typeof(Vistas_ViewHojaDeRutaABM_));
    ...
    protected void btnDescargarTemplateDSG_Click(object sender, EventArgs e)
    {
        WebClient webClient = new WebClient();
        try
        {

            string fileName = "FormatoGenerico.xls";
            //string currentFile = AppDomain.CurrentDomain.BaseDirectory + "Templates\\" + fileName;
            ...
            Response.AddHeader("Content-Disposition", "attachment; filename=" + curFile);
    ...
    /*
   protected void btnMarcarFilaGvModificacion_Click(object sender, ImageClickEventArgs e)
   {
       for (UInt16 i = 0; i < gvModificacion.Rows.Count; i++)
       {
           if (gvModificacion.Rows[i].Cells[4].Text.Contains(this.txtFindIdDeudor.Text))
               gvModificacion.Rows[i].BackColor = System.Drawing.Color.Blue;
           else
               gvModificacion.Rows[i].BackColor = System.Drawing.Color.Empty;
       }
   } */
    ...
    protected void btnExportarExcel_Click2(object sender, EventArgs e)
    {
        Response.Clear();
        ...
        gvModificacion.RenderControl(hw);
    ...
    protected void btnExportarExcel_Click(object sender, EventArgs e)
    {
        ...
        hrAExportar.DeudoresDeLahoja = lstDeudoresHojaDeRuta;
