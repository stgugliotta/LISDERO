...
public partial class Vistas_ViewHojaDeRutaEdicion : GobbiPage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            Ajax.Utility.RegisterTypeForAjax(typeof(Vistas_ViewHojaDeRutaEdicion));
    ...
    private void cargarHojasActivas(int nroHoja)
    {
        ...
        foreach (DeudorDataContracts deudorDC in lstDeudores)
        {
            ...
            deudorHojaDeRuta.Provincia = string.Empty;
