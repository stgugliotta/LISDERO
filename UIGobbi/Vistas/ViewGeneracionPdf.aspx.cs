...
public partial class Vistas_ViewGeneracionPdf : GobbiPage 
{
    protected void Page_Load(object sender, EventArgs e)
    {
       ...
       int idRemision = int.Parse(Request.Params.Get("idRemision"));
        ...
        try
        {
            System.IO.File.Delete(Server.MapPath("../PDF/Remision" + idRemision.ToString() + ".pdf"));
        }
        catch (Exception ex)
        {
        ...
        string filePath = MapPath("../PDF/Remision" + idRemision.ToString() + ".pdf");
