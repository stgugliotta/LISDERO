<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UCPopupOtrosContactosPersonas.ascx.cs" Inherits="Vistas_UCPopupOtrosContactosPersonas" %>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Panel ID="PanelCargoqueOcupa" runat="server" Height="380px" Width="310px">
                                                ...
                                                <tr class="gvAlternatingItem">
                                                    <td id="Td1"  align="left"  runat="server" Style="font-family: Verdana; font-size: 10px;
                                                    font-weight: bold;">
                                                ...
                                                <tr class="gvAlternatingItem">
                                                    <td id="Td2"  align="left" runat="server" Style="font-family: Verdana; font-size: 10px;
                                                    font-weight: bold;">
                                                ...
                                                <tr id="Tr1" class="gvAlternatingItem" runat="server" Style="font-family: Verdana; font-size: 10px;
                                                    font-weight: bold;">
                                                    <td  align="left">
                                                ...
                                                <tr id="Tr2" class="gvAlternatingItem" runat="server" Style="font-family: Verdana; font-size: 10px;
                                                    font-weight: bold;">
                                                    <td  align="left">
                        ...
                        <tr>                           
                            <td>
                                <table>
                                    <tr>
                                        <td>
                                            <asp:Panel ID="PanelEmpresas" runat="server"  Height="300px" Width="600px" ScrollBars="Vertical">                               
                                            <table>
                                                <tr>
                                                    <td>
                                        ...
                                        <td>
                                             <asp:Panel ID="PanelDatosOtrosContactos" runat="server"  Height="300px" Width="600px" ScrollBars="Vertical">
                                                    <table>
                                                               <tr>
                                                                  <td>
