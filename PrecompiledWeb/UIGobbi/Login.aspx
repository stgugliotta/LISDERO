<%@ page language="C#" autoeventwireup="true" inherits="_Login, App_Web_4y35smbb" maintainScrollPositionOnPostBack="true" %>
					...
					<table id="tblLogin" cellspacing="0" cellpadding="0" bgcolor="#FBFBFB" 
                        ...
                        <tr>
                         ...
                         <br />
                             ...
                             <asp:Image ID="Image1" runat="server"  ImageUrl="~/Images/fondoLisdero3.png"/>
                             <br />
                             <br />
						...
						<tr>
							...
							<td style="background-image:url('Images/TablasUp3.gif'); height: 22px;" 
                                colspan="6">
							    <span class="whiteTitle">Inicio de Sesión</span></td>
						...
						<tr>
							...
							<td valign="top" bgcolor="#FBFBFB" colspan="2" align="left" style="padding-left:5px">
								<table cellspacing="0" cellpadding="0" border="0" style="width: 199px">
									<tr>
										<td style="width: 59px">
										    <asp:textbox id="txtUsuario" runat="server" MaxLength="19" Width="136px"></asp:textbox>
										</td>
									</tr>
								</table>
							</td>
