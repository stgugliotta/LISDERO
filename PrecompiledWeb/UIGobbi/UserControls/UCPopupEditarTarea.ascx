<%@ control language="C#" autoeventwireup="true" inherits="Vistas_UCPopupEditarTarea, App_Web_d25i0xw0" %>
                                ...
                                <tr align="left">
                                    <td>
                                        <asp:TextBox ID="txtTarea" runat="server" AutoCompleteType="Disabled" CssClass="textArea"
                                            BackColor="White" Wrap="true" MaxLength="1000" Width="350px" TextMode="MultiLine"
                                            Columns="40" Rows="3" />
                                    </td>
                                </tr>
                                <tr>
