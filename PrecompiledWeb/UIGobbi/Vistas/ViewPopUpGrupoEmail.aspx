<%@ page title="" language="C#" masterpagefile="~/MasterPage.master" theme="SampleSiteTheme" enableeventvalidation="false" autoeventwireup="true" inherits="Vistas_ViewPopUpGrupoEmail, App_Web_a43a33gs" maintainScrollPositionOnPostBack="true" %>
...
<%@ Register Src="~/UserControls/UCPopupEditarGruposEmail.ascx" TagPrefix="myPopupDeDatos"
...
function abrirPopupAgenda1() 
{
      ...
      $find(ModalPopupResultados_EditarGrupoEmail).show();
