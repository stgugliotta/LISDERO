<%@ page language="C#" masterpagefile="~/MasterPage.master" theme="SampleSiteTheme" enableeventvalidation="false" autoeventwireup="true" inherits="Vistas_ViewAltaEmpresa, App_Web_j1kq45zw" maintainScrollPositionOnPostBack="true" %>
...
function RecoveryFilters()
{
 ...
 var varModalPopupAbierto;
  ...
  var elemento =document.getElementById('ctl00_Contentplaceholder1_TextBox1');
    ...
    <ajaxToolkit:ModalPopupExtender ID="ModalPopupNuevaCalificacion" runat="server" TargetControlID="HiddenFieldNuevaCiudad"
                                                              ...
                                                              <Columns>
                                                                 <asp:CommandField  ButtonType="Image"                                                                                                        
                                                                  ...
                                                                  HeaderText="Editar" ><HeaderStyle Font-Bold="True" /><itemstyle width="5%"  HorizontalAlign="Center"  /></asp:CommandField><asp:TemplateField HeaderText="Eliminar"><ItemTemplate><asp:ImageButton    OnClientClick ="return confirm('¿Esta seguro que desea eliminar el registro?');" Visible="true" ID="btnDelete" runat="server" ImageUrl="~/Images/delete.gif" CommandName="Delete"  /></ItemTemplate><HeaderStyle Font-Bold="True" /></asp:TemplateField>
                                                                     ...
                                                                     <RowStyle CssClass="gvItem" /></ma:XGridView>--%></asp:Panel>
        ...
        <tr style="height: 400px;">
            <td valign="top">
                            ...
                            <table width="auto" cellpadding="0" cellspacing="0" style="height: 400px">
                                <tr>
                                    <td align="center">
                                        <asp:panel id="pnlSeleccionarDatos" runat="server">
                                            ...
                                            <table style="width:auto;">
                                                    <tr align="left">
                                                        <td>
                                                            <asp:Label ID="lblNombre" runat="server" CssClass="labelBold" Text="Razón Social:" />
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                              <asp:Label runat="server" ID="lblFechaNombre" 
                                                                CssClass="labelBold" Width="100px"></asp:Label>
                                                        </td>
                                                        <tr>
                                    <td align="left">
                                    ...
                                    <td align="left">
                                        ...
                                        <asp:RegularExpressionValidator runat="server" ErrorMessage="*" ControlToValidate="txtCuit" ValidationGroup="datosGroup" ValidationExpression="^[0-9]{11}$" ></asp:RegularExpressionValidator>
                                        ...
                                        MaskType="none" TargetControlID="txtCuit" ></ajaxToolkit:MaskedEditExtender>
                                                                                                                
                                     </td>
                                     <td>
                                       <asp:Label ID="lblFechaCuit" runat="server" CssClass="labelBold" Width="100px"></asp:Label></td>
                ...
                <%--                    <tr align="left">
                                 ...
                                 <tr align="left">
                                                        <td>
                                                            <asp:Label ID="lblWeb" runat="server" CssClass="labelBold" Text="Web:" />
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txtWeb" runat="server" CssClass="textboxEditor" Width="300px" ValidationGroup="datosGroup"></asp:TextBox>
                                                        </td>
                                                        <td>
                                                            <asp:Label ID="lblFechaWeb" runat="server" CssClass="labelBold" Width="100px"></asp:Label>
                                                        </td>
                                                    </tr>
                                                     <tr align="left">
                                                        <td>
                                                            <asp:Label ID="lblHorario" runat="server" CssClass="labelBold" Text="Horario:" />
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txtHorario" runat="server" CssClass="textboxEditor" Width="300px" ValidationGroup="datosGroup"></asp:TextBox>
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidatorHorario" runat="server"
                                                                ControlToValidate="txtHorario" ErrorMessage="*" 
                                                                ValidationGroup="datosGroup" Display="Dynamic"></asp:RequiredFieldValidator>                                                           
                                                        </td>
                                                        <td>
                                                             <asp:Label ID="lblFechaHorario" runat="server" CssClass="labelBold" 
                                    ...
                                    <tr align="left">
                                        ...
                                        <td>
                                            ...
                                            <%--   <asp:RequiredFieldValidator ID="RequiredFieldValidatorTelNuevo" runat="server" ControlToValidate="txtTelefono"
                                                                Enabled="false" ErrorMessage="Ingrese el teléfono" ValidationGroup="datosGroup"></asp:RequiredFieldValidator>--%>&nbsp;<asp:RequiredFieldValidator 
                                       ...
                                       <tr align="left">
                                        <td>
                                            <asp:Label ID="lblIVA" runat="server" cssclass="labelBold" text="Condición IVA:" />
                                        </td>
                                        <td>
                                            ...
                                            &nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidatorIVA" 
                                                runat="server" controltovalidate="cmbIVA" errormessage="* " 
                                                validationgroup="datosGroup"></asp:RequiredFieldValidator>                                                                                                                 
                                        </td>
                                        <td>
                                             <asp:Label ID="lblFechaCondicionIva" runat="server" CssClass="labelBold" 
                                                 Width="100px"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr align="left">
                                        <td>
                                            <asp:Label ID="lblIIBB" runat="server" cssclass="labelBold" text="Condición IIBB:" />
                                        </td>
                                        <td>
                                            <asp:DropDownList ID="cmbIIBB" runat="server" 
                                                autocompletemode="SuggestAppend" backcolor="#FFFFCC" bordercolor="#B9B9B9" 
                                                borderstyle="Solid" borderwidth="1px" dropdownstyle="DropDownList" 
                                                font-names="Verdana" font-size="11px" height="20px" maxlength="0" 
                                                validationgroup="datosGroup" width="305px">
                                            </asp:DropDownList>
                                            &nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidatorIIBB" 
                                                runat="server" controltovalidate="cmbIIBB" errormessage="* " 
                                                validationgroup="datosGroup"></asp:RequiredFieldValidator>                                              
                                        </td>
                                        <td>
                                             <asp:Label ID="lblFechaCondicionIIBB" runat="server" CssClass="labelBold" 
                                                 Width="100px"></asp:Label>
                                        </td>
                                    </tr>
                                                    <tr align="left">
                                                        ...
                                                        <td>
                                                            <asp:Label ID="lblFechaContacto" runat="server" CssClass="labelBold" 
                                                                Width="100px"></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr align="left">
                                                        ...
                                                        <td>
                                                          <asp:Label ID="lblFechaVinculo" runat="server" CssClass="labelBold" Width="100px"></asp:Label>
                                                        </td>
                                                    </tr>                                                   
