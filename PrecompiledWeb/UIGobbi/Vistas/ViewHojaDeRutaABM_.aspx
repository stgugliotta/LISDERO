<%@ page title="" language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Vistas_ViewHojaDeRutaABM_, App_Web_a43a33gs" enableeventvalidation="false" maintainScrollPositionOnPostBack="true" %>
            ...
            <tr>
                <td style="width: 100%; height: 40px;" class="fondo_Titulo">
                    ...
                    <asp:button id="btnExportarExcelDSG" runat="server" cssclass="button" onclick="btnExportarExcelDSG_Click"
                        text="Hoja de Ruta Sin Gestión a XLS"  Visible="false" />
                </td>
            </tr>
        </table>
    </div>
        ...
        <ContentTemplate>
            <asp:Panel ID="pnlPrincipal" runat="server" Width="100%" Height="600px">
                <ajaxToolkit:Accordion ID="Accordion1" runat="server" TransitionDuration="250" FramesPerSecond="40"
                    FadeTransitions="true" HeaderCssClass="acc-header" ContentCssClass="acc-content"
                    HeaderSelectedCssClass="acc-selected">
                    <Panes>
                        <ajaxToolkit:AccordionPane ID="pnlConsulta" runat="server"  Visible="true">
                            <Header>
                                <table width="100%">
                                    <tr>
                                        <td>
                        ...
                        <ajaxToolkit:AccordionPane ID="pnlAlta" runat="server"  Visible="true"> 
                            <Header>
                                <table width="100%">
                                    <tr>
                                        <td>
                        ...
                        <ajaxToolkit:AccordionPane ID="pnlModificacion" runat="server"  Visible="true">
                            <Header>
                                <table width="100%">
                                    <tr>
                                        <td>
                        ...
                        <ajaxToolkit:AccordionPane ID="pnlModificacionDeudoresSinGestion" runat="server" Visible="true">
                            <Header>
