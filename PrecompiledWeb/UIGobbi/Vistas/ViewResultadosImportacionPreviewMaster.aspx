<%@ page language="C#" masterpagefile="~/MasterPage.master" theme="SampleSiteTheme" enableeventvalidation="false" autoeventwireup="true" inherits="Vistas_ViewResultadosImportacionPreviewMaster, App_Web_a43a33gs" maintainScrollPositionOnPostBack="true" %>
                                  ...
                                  <table cellpadding="0" cellspacing="0" class="borderCompleto" 
                                                 ...
                                                 <tr>
                                                     <td align="left" class="fondo_Titulo" style="height: 23px" width="100%;">
                                                          <table width="100%" >
                                                          <tr>
                                                          <td class="style5">Últimas importaciones (Preliminar)</td>
                                                          <td class="style6" valign="top"> <asp:TextBox ID="txtFechaDesde" runat="server" Width="84px" 
                                                               ...
                                                               <td valign="top">
                                                                <asp:Button runat="server" Text="Ver Preliminar" 
