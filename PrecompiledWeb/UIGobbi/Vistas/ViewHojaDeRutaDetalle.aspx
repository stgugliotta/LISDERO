<%@ page title="" language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Vistas_ViewHojaDeRutaDetalle, App_Web_j1kq45zw" maintainScrollPositionOnPostBack="true" %>
        ...
        <table cellpadding="0" cellspacing="0" class="borderCompleto" 
            ...
            <tr>
                <td align="left" class="fondo_Titulo" style="height: 23px" width="100%;">
                    <table width="100%">
                        <tr>
                            <td style="width:100%; height:30px;">Detalle de Zonas: </td><td valign="top"></td>
                        </tr>
                    </table>
                </td>
            </tr>
                         ...
                         <%--       <td class="labelBold">Zona:</td>--%>
                                ...
                                <asp:Label runat="server" class="labelBold" Text="Zona"></asp:Label>
                                    <ajaxToolkit:ComboBox ID="cmbZona" runat="server" AutoCompleteMode="SuggestAppend"
                                        ...
                                        MaxLength="0" Width="60px" OnSelectedIndexChanged="cmbZona_SelectedIndexChanged" AutoPostBack="True">
