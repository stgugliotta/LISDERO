<%@ page language="C#" autoeventwireup="true" inherits="Vistas_ViewPopUpHitoFactura, App_Web_j1kq45zw" maintainScrollPositionOnPostBack="true" %>
            ...
            <tr>
                <td style="background-color: #F2F2F2;">
                    ...
                    <asp:TextBox ID="txtInfoComplementaria" runat="server" CssClass="textboxEditor" Width="390px"
                        Height="22px" ReadOnly="false"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td style="background-color: #F2F2F2;">
