<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Vistas_ViewLocalizarRecibo, App_Web_j1kq45zw" title="Localizar Recibo" maintainScrollPositionOnPostBack="true" %>
                                            ...
                                            <ma:XGridView ID="gvResultados" runat="server"  AllowSorting="True"
                                               ...
                                               <%-- <asp:CommandField HeaderText="Editar Recibo" ShowSelectButton="True" />--%>
                                                    ...
                                                    <asp:CommandField HeaderText="Descargar remisión" ShowCancelButton="False" 
                                                        ButtonType="Button" EditText="Descargar" ShowEditButton="True" >
