<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Vistas_ViewRemisionDeValores, App_Web_j1kq45zw" maintainScrollPositionOnPostBack="true" %>
                                                                                              ...
                                                                                              <td align="left" >
                                                                                               ...
                                                                                               <td align="left" style="width:195px;">
                                                                                                ...
                                                                                                <td align="left"><asp:Label ID="lblCheque" runat="server" Style="font-family: Verdana; font-size: 9px;"
                                                                                                                ...
                                                                                                                CultureDatePlaceholder="" CultureDecimalPlaceholder="" CultureThousandsPlaceholder=""
                                                                                                                CultureTimePlaceholder="" Enabled="True" ErrorTooltipEnabled="True" Mask="99/99/9999"
                                                                                                                MaskType="Date" TargetControlID="txtFechaEmision"></ajaxToolkit:MaskedEditExtender><ajaxToolkit:MaskedEditValidator ID="mev1" runat="server" ControlExtender="txtFechaEmision_MaskedEditExtender"
                                                                                                 ...
                                                                                                 <td><asp:Label ID="lblFechaVenc" runat="server" Style="font-family: Verdana; font-size: 9px;"
                                                                                                                ...
                                                                                                                CultureDatePlaceholder="" CultureDecimalPlaceholder="" CultureThousandsPlaceholder=""
                                                                                                                CultureTimePlaceholder="" Enabled="True" ErrorTooltipEnabled="True" Mask="99/99/9999"
                                                                                                                MaskType="Date" TargetControlID="txtFechaVencimiento"></ajaxToolkit:MaskedEditExtender><ajaxToolkit:MaskedEditValidator ID="mev2" runat="server" ControlExtender="txtFechaVencimiento_MaskedEditExtender"
                                                                                                                ControlToValidate="txtFechaVencimiento" Display="None" EmptyValueMessage="*"
                                                                                                                ErrorMessage="*" InvalidValueMessage="*" IsValidEmpty="False"
                                                                                                                ValidationGroup="chequeGroup" /><asp:ImageButton ID="imgFecha4" runat="server" ImageUrl="~/Images/Calendar.png" /><asp:CheckBox ID="chkCP" runat="server" Text="Cheq Pago" AutoPostBack="True" 
