<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Vistas_ViewRemisionDeValoresEdicion, App_Web_a43a33gs" maintainScrollPositionOnPostBack="true" %>
...
function beginReq(sender, args) 
{
    ...
    if(controlCaller.indexOf('btnGuardarReciboEdicion')!=-1){$find(ModalPopupCargando).show()};
...
function AbrirPopUpLocalizarFactura()
{
  var url='http://' + document.location.host + '/Vistas/ViewLocalizarFactura.aspx';
           AbrirVentana3(url,'_blank',1010,520);
}
...
alert('abrio el popup');
    var panelGeneral=document.getElementById('ctl00_Contentplaceholder1_panelGeneralCuerpoPagina');
     ...
     alert('se va por aca');
      ...
      if(confirm("Editar un recibo implica eliminar los datos de ésta pantalla que aún no fueron guardado ¿Desea continuar?")) 
      { 
...
//function CheckearFacturasPersistidas()
//{
//alert('aaaa');
//alert('bbb');
////var check = document.getElementById(objeto);  
////var textboxAImputar = document.getElementById(objeto.replace('chk','txtAImputarPorFactura'));
////var btnPP = document.getElementById(objeto.replace('chk','ctl01'));
////textboxAImputar.setAttribute('value',textboxAImputar.value);
////textboxAImputar.disabled=true;
////btnPP.disabled=true;
////check.checked=true;
////var tablaFacturas = document.getElementById('ctl00_Contentplaceholder1_GvResultadosFacturas');
//return true;

//}

function TildarFacturasPersistidas(objeto)
{
...
//  btnGuardarRecibo=document.getElementById('<%=this.btnGuardarReciboEdicion.ClientID %>');
...
//function LimpiarTextboxRecibo()
//{
//    __doPostBack('ctl00_Contentplaceholder1_cmbClientes','1');
//}
                                                    ...
                                                    <tr>
                                                        <td align="left">
                                                          <asp:DropDownList ID="cmbDeudores" runat="server" AutoCompleteMode="SuggestAppend"
                                                                AutoPostBack="True" BackColor="#FFFFCC" BorderColor="#B9B9B9" BorderStyle="Solid"
                                                                BorderWidth="1px" DropDownStyle="DropDownList" Font-Names="Verdana" Font-Size="10px"
                                                                Height="20px" MaxLength="0" OnDataBound="cmbDeudores_DataBound" Width="100px" 
                                                                 >
                                                            </asp:DropDownList>
                                                    ...
                                                    <tr>
                                                        <td align="left">
                                                          <asp:UpdatePanel runat="server" ID="updateRecibosDisponibles" UpdateMode="Conditional" >
                                                            <ContentTemplate>
                                                            <asp:DropDownList ID="cmbRecibosDisponibles" runat="server" AutoCompleteMode="SuggestAppend"
                                                                AutoPostBack="True" BackColor="#FFFFCC" BorderColor="#B9B9B9" BorderStyle="Solid"
                                                                BorderWidth="1px" DropDownStyle="DropDownList" Font-Names="Verdana" Font-Size="10px"
                                                                Height="20px" MaxLength="0" OnDataBound="cmbRecibosDisponibles_DataBound" OnTextChanged="cmbRecibosDisponibles_TextChanged" Width="120px">
                                                            </asp:DropDownList>
                                                            </ContentTemplate> 
                                                            </asp:UpdatePanel> 
                                                        </td>
                                                        ...
                                                        <tr>
                                                                                            ...
                                                                                            <tr>
                                                                                              <td align="left" >
                                                                                               ...
                                                                                               <td align="left" style="width:195px;">
                                                                                                                ...
                                                                                                                MaxLength="12" TabIndex="10" ValidationGroup="chequeGroup" Width="83px"></asp:TextBox>
                                                                                                ...
                                                                                                <td align="left"><asp:Label ID="lblCheque" runat="server" Style="font-family: Verdana; font-size: 9px;"
                                                                                                                ...
                                                                                                                MaxLength="8" TabIndex="11" ValidationGroup="chequeGroup" Width="83px"></asp:TextBox>
                                                                                                                ...
                                                                                                                ValidationGroup="chequeGroup" Width="83px" TabIndex="12"></asp:TextBox><ajaxToolkit:CalendarExtender
                                                                                                                    ID="txtFechaEmision_CalendarExtender" runat="server" Enabled="True" Format="dd/MM/yyyy"
                                                                                                                    PopupButtonID="imgFecha3" TargetControlID="txtFechaEmision"></ajaxToolkit:CalendarExtender><ajaxToolkit:MaskedEditExtender ID="txtFechaEmision_MaskedEditExtender" runat="server"
                                                                                                                CultureAMPMPlaceholder="" CultureCurrencySymbolPlaceholder="" CultureDateFormat=""
                                                                                                                CultureDatePlaceholder="" CultureDecimalPlaceholder="" CultureThousandsPlaceholder=""
                                                                                                                CultureTimePlaceholder="" Enabled="True" ErrorTooltipEnabled="True" Mask="99/99/9999"
                                                                                                                MaskType="Date" TargetControlID="txtFechaEmision"></ajaxToolkit:MaskedEditExtender><ajaxToolkit:MaskedEditValidator ID="me1" runat="server" ControlExtender="txtFechaEmision_MaskedEditExtender"
                                                                                                                ControlToValidate="txtFechaEmision" Display="None" EmptyValueMessage="*"
                                                                                                                ErrorMessage="*" InvalidValueMessage="*" IsValidEmpty="False"
                                                                                                                ValidationGroup="chequeGroup" /><asp:ImageButton ID="imgFecha3" runat="server" ImageUrl="~/Images/Calendar.png" /></td>
                                                                                                                </tr>
                                                                                                 <tr>
                                                                                                 <td><asp:Label ID="lblFechaVenc" runat="server" Style="font-family: Verdana; font-size: 9px;"
                                                                                                                ...
                                                                                                                TabIndex="13" ValidationGroup="chequeGroup" Width="83px"></asp:TextBox>
                                                                                                                
                                                                                                                <ajaxToolkit:CalendarExtender

                                                                                                                    ID="CalendarExtender1" runat="server" Enabled="True" Format="dd/MM/yyyy" PopupButtonID="imgFecha4"
                                                                                                                    TargetControlID="txtFechaVencimiento"></ajaxToolkit:CalendarExtender><ajaxToolkit:MaskedEditExtender ID="txtFechaVencimiento_MaskedEditExtender" runat="server"
                                                                                                                CultureAMPMPlaceholder="" CultureCurrencySymbolPlaceholder="" CultureDateFormat=""
                                                                                                                CultureDatePlaceholder="" CultureDecimalPlaceholder="" CultureThousandsPlaceholder=""
                                                                                                                CultureTimePlaceholder="" Enabled="True" ErrorTooltipEnabled="True" Mask="99/99/9999"
                                                                                                                MaskType="Date" TargetControlID="txtFechaVencimiento"></ajaxToolkit:MaskedEditExtender><ajaxToolkit:MaskedEditValidator ID="me2" runat="server" ControlExtender="txtFechaVencimiento_MaskedEditExtender"
                                                                                                                ControlToValidate="txtFechaVencimiento" Display="None" EmptyValueMessage="*"
                                                                                                                ErrorMessage="*" InvalidValueMessage="*" IsValidEmpty="False"
                                                                                                                ValidationGroup="chequeGroup" /><asp:ImageButton ID="imgFecha4" runat="server" ImageUrl="~/Images/Calendar.png" /><asp:CheckBox ID="chkCP" runat="server" Text="Cheq de Pago" AutoPostBack="True" 
                                                                                                                ...
                                                                                                                <td align="left" style="width:195px;"><asp:TextBox ID="txtBanco" runat="server" CssClass="textboxEditor" Height="16px"
                                                                                                                ...
                                                                                                                <td align="left" style="width:195px;"><asp:TextBox ID="txtSucursal" runat="server" CssClass="textboxEditor" Height="16px"
                                                                                                                ...
                                                                                                                Width="83px" MaxLength="13" AutoPostBack="False" TabIndex="17" IsValidEmpty="True"></asp:TextBox>
                                                                                                               ...
                                                                                                               <asp:RequiredFieldValidator
                                                                                                                ...
                                                                                                                ValidationGroup="chequeGroup" Width="83px" MaxLength="20" TabIndex="18"></asp:TextBox>
                                                                                                                <%--<asp:RequiredFieldValidator
                                                                                                                ...
                                                                                                                Width="83px" MaxLength="4" TabIndex="19" OnBlur="AplicarFocoAgregarPago()"></asp:TextBox>
                                                                                                                <%--<asp:RequiredFieldValidator
                                                                                        ...
                                                                                        <ajaxToolkit:TabPanel runat="server" ID="TabPanel1" HeaderText="Retencion" Enabled="true"
                                                                                            Visible="true"><HeaderTemplate>Reten</HeaderTemplate><ContentTemplate><asp:UpdatePanel runat="server" ID="UpdatePanelSubtipoRetencion" UpdateMode="Conditional"><ContentTemplate><table style="margin-top: 15px;"><tr><td align="left"><asp:Label ID="lblSubtipoRetencion" runat="server" Style="font-family: Verdana; font-size: 9px;"
                                                                                                                        ...
                                                                                                                        Width="83px" MaxLength="15" ValidationGroup="retencionesGroup" TabIndex="23"></asp:TextBox><asp:RequiredFieldValidator
                                                                                                                            ...
                                                                                                                            </td></tr><tr><td><asp:Label ID="lblFechaRetencion" runat="server" Style="font-family: Verdana; font-size: 9px;" Text="Fecha Retención: "></asp:Label>
                                                                                                                       ...
                                                                                                                       <td>
                                                                                                                        ...
                                                                                                                        <ajaxToolkit:MaskedEditValidator ID="me55" runat="server" ControlExtender="MaskedEditExtender2"
                                                                                                ...
                                                                                                <table>
                                                                                                      <tr>
                                                                                                          <td style="font-family:Verdana;font-size:9px;">
                                                                                                              <%-- Moneda Extranjera <input id="chkPesificar" type="checkbox" onclick="javascript:LimpiarCampoTipoDeCambio();"/>        --%>          
                                                                                                                       <asp:CheckBox ID="chkPestreificar" runat="server" Checked="false" Text="Moneda Extranjera" style="font-family:Verdana;font-size:9px;position:absolute;margin-left:-120px;" OnClientClick="return alert('asd');"/>
                                                                                                          ...
                                                                                                          <td>
                                                                                                                   <asp:UpdatePanel runat="server" ID="updatePanelBtnAgregarPago" UpdateMode="Conditional">
                                                                                                                    <ContentTemplate>
                                                                                                                      ...
                                                                                                                      <input id="btnAgregarPagoClientSide" type="button" value="Agregar Valor" onclick="OnClick_btnAgregarPago();" class="button_back3"   tabindex="100" />
                                                            ...
                                                            <td valign="top" align="left" >
                                                                <asp:Panel ID="pnlFacturas" runat="server" Height="365px" CssClass="scrollbar" 
                                                                    ScrollBars="Vertical" Width="580px">
                                                                        ...
                                                                        <ContentTemplate>
                                                                            ...
                                                                            <ma:XGridView ID="GvResultadosFacturas" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                                                ...
                                                                                ExecutePageIndexChanging="False" OnFilling="GvResultadosFacturas_Filling" OnPreRender="GvResultadosFacturas_PreRender"
                                                                                 OnSorted="GvResultadosFacturas_Sorted" 
                                                                                ...
                                                                                <Columns>
                                                                                    ...
                                                                                    <asp:BoundField DataField="montoUltimaImputacion" HeaderText="Ultima Imputacion" ItemStyle-HorizontalAlign="Right"/>
                                                                                    <asp:BoundField DataField="moneda" HeaderText="Moneda" />
                                                            ...
                                                            <td style="border-style: groove groove outset outset; border-bottom-color: #FFFFFF;
                                                                ...
                                                                <asp:UpdatePanel ID="UpdatePanelResultados" runat="server" UpdateMode="Conditional">
                                                                    <Triggers>
                                                                        ...
                                                                        <asp:AsyncPostBackTrigger ControlID="btnGuardarReciboEdicion" />
                                                        ...
                                                        <tr>
                                                            <td colspan="2">
                                                                <table width="95%">
                                                                    <tr>
                                                                        <td align="center">
                                                                            <ma:SecureButton ID="btnGuardarReciboEdicion" runat="server" CausesValidation="True" CssClass="button_back3"
                                                                                Height="20px" OnClick="btnGuardarReciboEdicion_Click" OnClientClick="return ValidarDatosDelRecibo();"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <%--        <asp:UpdatePanel ID="UpdatePanelVerPdfRemisionEnCurso" runat="server" UpdateMode="Conditional">
                                                                                 ...
                                                                                 <%--   <asp:LinkButton ID="linkButtonRemisionEncurso" runat="server" Style="font-family: Verdana; font-size: 9px;"
                                                                                                                    ...
                                                                                                                    <a href="javascript:GenerarPdf();" style="font-family: Verdana; font-size: 9px;">Remisión en Curso</a>
                                                                          <%--          </ContentTemplate>
                                                                                    </asp:UpdatePanel>--%>
                                                                        </td>
                                                                        <td align="right">
                                                                            ...
                                                                            <asp:CheckBox ID="chkMail" runat="server" Text="Enviar Mail | " style="font-family:Verdana;font-size:10px;font-weight:bold;" visible="false" />
