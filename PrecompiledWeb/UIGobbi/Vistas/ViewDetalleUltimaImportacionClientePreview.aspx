<%@ page language="C#" masterpagefile="~/MasterPage.master" theme="SampleSiteTheme" enableeventvalidation="false" autoeventwireup="true" inherits="Vistas_ViewDetalleUltimaImportacionClientePreview, App_Web_qoidtvmg" maintainScrollPositionOnPostBack="true" %>
                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="height: 380px" >
                 ...
                 <tr align="center"  style="height:400px;" >
                     <td valign="top" style="width: 900px; margin-left: 80px; text-align:center;" align="center">
                         ...
                         <asp:Panel ID="panelCliente" runat="server" Width="900px" Height="300px" align="center">
                                             ...
                                             <table style="width:850px; height:98%;" class="borderCompleto" cellpadding="0" cellspacing="0">
                                                ...
                                                <tr>
                                                    <td align="center" style="height: 30px;" class="fondo_Titulo" width="100%;">
                                                      <%--  <asp:Button runat="server"  ID="btnReprocesar" CssClass="button_back" OnClick="btnReprocesar_Click" Text="Reprocesar" Enabled="False"  />--%>
                                                    </td>
                                                </tr>
                                             </table>
                                             </Content>
