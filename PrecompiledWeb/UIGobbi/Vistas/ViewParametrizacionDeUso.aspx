<%@ page language="C#" masterpagefile="~/MasterPage.master" theme="SampleSiteTheme" enableeventvalidation="false" autoeventwireup="true" inherits="Vistas_ParametrizacionDeUso, App_Web_j1kq45zw" maintainScrollPositionOnPostBack="true" %>
...
<table cellpadding="0" border="0" cellspacing="0" style="width:100%;height:332px; left:0;">
                ...
                <tr><td align="left" style="height: 149px" valign="top"><br />
                    ...
                    <asp:gridview runat="server" AutoGenerateColumns="False" 
                        ...
                        ConnectionString="<%$ ConnectionStrings:EMACSA_NUCLEOConnectionString %>" 
                    ...
                    <asp:SqlDataSource ID="SqlDataSource9" runat="server" 
                        ...
                        UpdateCommand="UPDATE [USERS] SET [UserName] = @UserName, [password] = @password, [dvh] = @dvh, [GroupId] = @GroupId WHERE [UserID] = @original_UserID AND [UserName] = @original_UserName AND (([password] = @original_password) OR ([password] IS NULL AND @original_password IS NULL)) AND (([dvh] = @original_dvh) OR ([dvh] IS NULL AND @original_dvh IS NULL)) AND (([GroupId] = @original_GroupId) OR ([GroupId] IS NULL AND @original_GroupId IS NULL))">
                        <DeleteParameters>
