<%@ page title="" language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Vistas_ViewHojaDeRutaDeudoresSinGestion, App_Web_a43a33gs" maintainScrollPositionOnPostBack="true" %>
...
//       
    ...
    BackgroundCssClass="modalBackground" PopupControlID="panelUpdateProgress" />
                     ...
                     <table>
                             <tr>
                                 <td>
                                     <asp:Panel ID="pnlDeudoresSinGestion" runat="server" Width="100%" Height="80px">
                                            <table width="100%">
                            <tr>
                            ...
                            <tr>
                                <td style="width: 100%; height: 40px;">
                                    <asp:dropdownlist id="cmbClientes" runat="server" autocompletemode="SuggestAppend"
                                        ...
                                        maxlength="0" width="177px" Visible="False">
                                </asp:dropdownlist>
        ...
        <asp:updatepanel id="upHojaDeRutaABM" runat="server">
            <ContentTemplate>
             <asp:Panel ID="pnlConsulta" runat="server" Width="100%" Height="150px" CssClass="scrollbar" >
                                            ...
                                            <td colspan="7" align="left" valign="top">
                                                <asp:Panel ID="Panel1" runat="server" CssClass="scrollbar" Height="124px" Width="863px">
                                                    <asp:GridView ID="gvHojasActivas" runat="server" AutoGenerateColumns="False" CellPadding="3"
                                                        ...
                                                        Width="100%" onrowdeleting="gvHojasActivas_RowDeleting">
                                                        <AlternatingRowStyle CssClass="gvAlternatingItem" />
                                                        <Columns>
                                                            <asp:CommandField ShowEditButton="True" ShowHeader="True" EditText="Editar" />
                        ...
                        <asp:Panel ID="pnlModificacionDeudoresSinGestion" runat="server" Width="100%">
